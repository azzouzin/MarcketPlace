...
import '../../Forget_password/inputemail_screen.dart';
...
class _LoginContentState extends State<LoginContent>
      ...
      child: ElevatedButton(
        onPressed: () async {
          ...
          if (title == 'Sign Up') {
            if (emailC.text.contains('@') || emailC.text.contains('.com')) {
              if (passwordC.text.contains(new RegExp(r'[0-9]')) ||
                ...
                if (passwordC.text.length > 8) {
                  await authcontroller.register(emailC.text, passwordC.text,
            ...
            await authcontroller.login(emailC.text, passwordC.text, context);
          }
  ...
  Future<void> signIn() async {
    ...
    if (_currentUser == null) {
      ...
      String? firstname = _currentUser!.displayName!.split(' ')[0];

      String? lastname = _currentUser!.displayName!.split(' ')[1];
      ;
      ...
      print(email);
      print(id);
      AuthController().googlelogin(email, firstname, lastname, id, context);
    }
  }
